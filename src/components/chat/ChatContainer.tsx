...
export function ChatContainer({ historyId }: ChatContainerProps) {
  ...
  return (
    <div>
      <GradientBg />
      <div className="relative flex-1 flex flex-col w-full h-screen">
        {/* Messages */}
        {!isHome && (
        ...
        {isHome ? (
          <div className="flex flex-col items-center justify-center h-full px-4 text-center">
            ...
            <InputArea onSend={sendMessage} className="w-full max-w-4xl bg-transparent" />
          </div>
        ) : (
          /* Input bar */
          <div
          ...
          >
            <div className="max-w-4xl mx-auto px-2">
              <InputArea onSend={sendMessage} className="bg-transparent" />
            </div>
          </div>
        )}
      </div>
